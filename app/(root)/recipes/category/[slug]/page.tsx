...
import { canPerformAction, incrementUsage, getUserUsage, getUserSubscriptionInfo } from '@/src/lib/subscription';
...
export default async function RecipePage({ params }: PageProps) {
  ...
  // Check subscription limits BEFORE fetching recipe
      ...
      <div className="wrapper page">
        <div className="max-w-2xl mx-auto text-center py-16 px-4">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-lg mb-2">{viewCheck.reason}</p>
            {subscription && usage && (
  ...
  // Increment view counter AFTER successfully loading the recipe
  ...
  return (
    <div className="wrapper page">
      ...
      {subscription?.planId === 'free' && updatedUsage && subscription.limits.monthlyRecipeViews && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-between">
            <p className="text-sm text-blue-800">
              <span className="font-medium">
                {updatedUsage.recipeViews} of {subscription.limits.monthlyRecipeViews} recipe views used this month
              </span>
              {subscription.limits.monthlyRecipeViews - updatedUsage.recipeViews <= 1 && (
