...
export const premiumFeatures = pgTable(
  'premium_features',
  {
  ...
  (table) => ({
    ...
    userFeatureUnique: unique('premium_features_user_feature_unique').on(
      table.userId,
      table.feature
    ),
  })
...
export const recipeCollectionItems = pgTable(
  ...
  (table) => ({
    collectionRecipeIdx: index('recipe_collection_items_collection_recipe_idx').on(
      table.collectionId,
      table.recipeId
    ),
    recipeIdx: index('recipe_collection_items_recipe_idx').on(table.recipeId),
    collectionRecipeUnique: unique('recipe_collection_items_collection_recipe_unique').on(
      table.collectionId,
      table.recipeId
    ),
  })
