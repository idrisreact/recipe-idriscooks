...
import { Play, Pause, SkipForward, SkipBack, ChevronUp, ChevronDown, X, Music } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-2">
        <div className="flex items-center gap-2 text-[var(--primary)]">
          ...
          <span className="text-[10px] uppercase tracking-[0.15em] font-medium">Now Playing</span>
        </div>
        <div className="flex items-center gap-1">
          <motion.button
            whileHover={{ scale: 1.1 }}
      ...
      <div className="border-t border-white/[0.04]">
        <div className="max-h-[200px] overflow-y-auto scrollbar-thin" data-lenis-prevent>
