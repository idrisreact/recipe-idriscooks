      ...
      <section ref={sectionRef} className="wrapper my-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="murakamicity-card p-6 animate-pulse"
            >
    ...
    <section ref={sectionRef} className="wrapper my-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {recipes.map((recipe, index) => {
          const imageUrl = recipe.imageUrl || recipe.image_url || '/images/default-recipe.jpg';
          ...
          return (
            ...
            >
              <div className="murakamicity-card overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105">
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                    <ActionButton
                      ...
                      ariaLabel={`${favorited ? 'Remove from' : 'Add to'} favorites`}
                ...
                {/* Recipe Content */}
                <div className="p-6">
                  <Text as="h3" variant="large" className="font-semibold mb-2 line-clamp-2">
                    {recipe.title}
                  </Text>
