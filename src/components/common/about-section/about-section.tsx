      ...
      <div className="wrapper">
        <header className="flex flex-col md:flex-row items-center max-w-4xl w-full murakamicity-card p-8 gap-8 mb-16">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            <Text as="h1" id="about-title" variant="heading" className="mb-4">
              Idris Taiwo
            </Text>
            <Text variant="large" className="text-primary font-semibold mb-6">
              Chef & Recipe Creator
            </Text>
            <Text variant="large" className="text-muted-foreground leading-relaxed">
              ...
              find inspiration, tips, and a world of flavors here. Let&apos;s cook something amazing
              together!
            </Text>
